    ...
    with ui.sidebar(width=300):
        ...
        def server_status():
            try:
                ...
                return ui.div(
                    ui.span(style="display: inline-block; width: 10px; height: 10px; border-radius: 50%; background-color: #28a745; margin-right: 5px;"),
                    "TiTiler server: Connected"
                )
            except:
                return ui.div(
                    ui.span(style="display: inline-block; width: 10px; height: 10px; border-radius: 50%; background-color: #dc3545; margin-right: 5px;"),
                    "TiTiler server: Not connected",
                    ui.p("Start server at port 8000", style="color: #dc3545; font-size: 0.8rem; margin-top: 5px;")
                )
